==================================================
Открытие депозита, инициированное через сайт (MVP)
==================================================
...
#. Клиент заполняет форму с контактными данными, выбранным депозитом и желаемой
   суммой.
#. Сайт регистрирует заявка на обратный звонок в системе колл-центра.
#. Система колл-центра информирует менеджеров колл-центра о наличии новой
   заявки.
#. Менеджер колл-центра берёт заявку в работу.
#. Менеджер колл-центра видит набор ставок по депозитам.
...
#. АБС отправляет в СМС-шлюз телеком оператора уведомление клиенту о
   подтверждении заявки и делает заявку доступной для менеджеров фронт-офиса.
